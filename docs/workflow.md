...
>
> ⚠️ **최신 변경 (2026-04-23)**: ADR-011/012로 Ollama(임베딩 + LLM) 완전 제거. 임베딩은 log-analyzer 컨테이너 내 FastEmbed(ONNX) 인프로세스로 이관(bge-m3 1024 + BM25 Hybrid). 과거 Ollama 구축/설정 섹션은 역사 자료로 간주. 운영 기준은 `deploy-guide.md` 참조.
