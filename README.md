...
- **Promtail → Grafana Alloy 교체**: Promtail v3.x의 glibc 2.34+ 의존성 문제로 RHEL 8.9(glibc 2.28) 실행 불가 → Alloy로 대체
- Grafana Alloy: 멀티라인 처리 + 빈줄 제거 + 에러 키워드 필터 + 레벨 라벨 추출 + JEUS ACL 설정 자동화
