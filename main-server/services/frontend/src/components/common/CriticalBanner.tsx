...
export function CriticalBanner() {
  ...
  return (
    <button
      ...
      className="bg-surface border-critical focus-visible:ring-accent fixed inset-x-0 top-0 z-50 flex cursor-pointer items-center justify-center gap-2 border-b-2 px-4 py-2 text-sm font-semibold tracking-wide text-critical-text transition-colors hover:bg-bg-base focus-visible:ring-1 focus-visible:outline-none"
    >
