...
const NAV_ITEMS: NavItem[] = [
  { to: '/chat', label: 'AI 어시스턴트', group: 'AI' },
  ...
  { to: '/feedback/manage', label: '해결책 관리', group: '알림' },
  { to: '/reports', label: '안정성 리포트', group: '분석' },
  { to: '/search', label: '유사 장애 검색', group: '분석' },
  { to: '/ssl', label: 'SSL 인증서', group: '관리', adminOnly: true },
  { to: '/ssl/servers', label: 'SSL 서버 관리', group: '관리', adminOnly: true },
  { to: '/ssl/deployments', label: 'SSL 배포 이력', group: '관리', adminOnly: true },
